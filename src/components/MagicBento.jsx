...
const DEFAULT_CARDS = [
  {
    ...
    metrics: '60+ steps · 500+ files indexed · −60% irrelevant context · −35% AI cost',
...
const ParticleCard = ({
  ...
  useEffect(() => {
    ...
    const handleClick = e => {
      if (!disableAnimations && clickEffect) {
          ...
          const body = (
            <>
              ...
              <div className="magic-bento-card__content">
                ...
                {card.metrics ? (
                  <p className="magic-bento-card__metrics">{card.metrics}</p>
                ) : null}
              </div>
              {card.stack ? <div className="magic-bento-card__stack">{card.stack}</div> : null}
            </>
          );
          ...
          if (enableStars) {
            return (
              <ParticleCard
                ...
                onActivate={() => openCardHref(card.href)}
              >
                {body}
              </ParticleCard>
            );
